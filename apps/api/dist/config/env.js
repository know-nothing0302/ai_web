...
exports.env = {
    ...
    wecomBaseUrl: process.env.WECOM_BASE_URL ?? "https://qyapi.weixin.qq.com/cgi-bin",
    ...
    wecomTokenRefreshSkewSeconds: toInt(process.env.WECOM_TOKEN_REFRESH_SKEW_SECONDS, 300),
    ...
    deepseekApiBaseUrl: firstNonEmpty(process.env.DEEPSEEK_API_BASE_URL, process.env.AI_XY_API_URL),
    deepseekApiKey: firstNonEmpty(process.env.DEEPSEEK_API_KEY, process.env.AI_XY_API_KEY),
    deepseekModel: firstNonEmpty(process.env.DEEPSEEK_MODEL, process.env.AI_XY_DEFAULT_GPT_TYPE, "deepseek-chat"),
    ...
    articlePublishJwtMaxTtlSeconds: toInt(process.env.ARTICLE_PUBLISH_JWT_MAX_TTL_SECONDS, 900),
