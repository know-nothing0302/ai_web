...
const personaStyleByUserType = {
    teacher: "该用户为教师/教职工。personaPrompt 应采用专业、学术化措辞，可适度使用领域术语，强调系统性分析和学科前沿，回答应体现研究视角和教学应用价值。",
    undergraduate: "该用户为本科生。personaPrompt 应采用直白、易懂的措辞，避免术语堆砌，用生活化类比解释复杂概念，回答应侧重基础理解和实际应用，帮助他们建立知识框架。",
    graduate: "该用户为研究生。personaPrompt 应采用启发式、研究导向的措辞，鼓励批判性思考，提供可深入的研究方向和学术资源，回答应体现方法学意识和学科交岔视野。",
    unknown: "用户类型未知。personaPrompt 应保持中性，兼顾可读性与深度，等待更多行为数据后再调整风格。",
};
